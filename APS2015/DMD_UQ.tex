...
%  can have on identified quantities such as DMD modes and eigenvalues. 
  ...
  %Focusing on the outputs of DMD, rather than the original data, allows us to study both the robustness of the algorithm, and 
  %Much is known
  ...
  (PCE). 
  %This method is advantageous for two reasons. 
